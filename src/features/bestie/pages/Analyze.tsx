...
const Analyze = () => {
  ...
  return (
    <div className="container px-4 mx-auto flex flex-col items-center flex-1">
      <div className="bg-white/80 dark:bg-gray-900/70 p-8 mt-6 rounded-xl shadow-lg w-full max-w-md animate-fade-in text-center">
        <div className="mb-5 text-3xl font-bold text-purple-700 dark:text-pink-300">
        ...
        <div className="text-sm text-muted-foreground mb-1">
          Prompts are now tailored to your emotional lens. Switch modules below
          anytime.
        </div>
      </div>
    </div>
